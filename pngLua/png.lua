class = dofile(minetest.get_modpath("realmap") .. "/pngLua/30log.lua")
deflate = dofile(minetest.get_modpath("realmap") .. "/pngLua/deflate.lua")
dofile(minetest.get_modpath("realmap") .. "/pngLua/stream.lua")
...
function pngImage:__init(png_str, progCallback)
	local str = Stream({input = png_str})
